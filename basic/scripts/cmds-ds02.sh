...
export FILENAME="../picopaper/exp-Basic-EENI-Mem-Initial-Weighted-False.tex" ; \
...
export FILENAME="../picopaper/exp-Cally-EENI-Low-QuasiInitial-ByExec2-True.tex" ; \
	echo '\\gdef\\bugtableinfo{'$FILENAME'}%' > $FILENAME.tmp ; \
	./TMUDriver \
	  --which-tmm-routine=NoTMMRoutine \
	...
	mv $FILENAME.tmp $FILENAME; \
	scp $FILENAME antals@eniac.seas.upenn.edu:~/html/picotables/
mail -s 'Finished running commands on ds02 <EOM>' antals@seas.upenn.edu < /dev/null
